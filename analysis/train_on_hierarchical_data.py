...
NUM_TOKENS = 10 * 10 ** 6  # must always be at least 1M
MAX_NGRAM_SIZE = 1
NUM_DESCENDANTS = 2  # 2
NUM_LEVELS = 8  # 12
E = 0.2  # 0.2
...
for legals_distribution in LEGALS_DISTRIBUTIONS:
    # make tokens with hierarchical n-gram structure
    vocab, tokens, ngram2legals_mat = make_data(
        NUM_TOKENS, legals_distribution, MAX_NGRAM_SIZE, NUM_DESCENDANTS, NUM_LEVELS, E)
    num_vocab = len(vocab)
